...
exports.generateAccountNumber = (countryCode, accountType = "personal") => {
  ...
  const accountTypePrefix =
    accountTypePrefixes[accountType.toLowerCase()] || "0";
  ...
  console.log(
    `Generated account number for country ${countryCode} and account type ${accountType}: ${accountNumber}`,
  );
